...
| **W13** | （总控） | `INTEGRATE.md` · 合入计划 | **READY_FOR_HUMAN_GATE** + findings §6 | W12 | merge main / publish **另授** |
| **CR** | `cv-cr-cdp-bind-docs` | findings CV-CR-001/002 文档 | **ACCEPT** `2991838` · origin · wt rm | findings | SECURITY/usage · test 0/0 |
...
| D0 findings | 并入 INTEGRATE §6 · 开 cv-cr-cdp-bind-docs | **1 cr docs** | 无 P0 · 禁 asar/main |
