...
| **W9** | `cv-theme-arina-only-docs` | arina-only 与 catalog 纪律文档 | **LIVE** | W1 | docs 一致 · 不扩 catalog |
| **W10** | `cv-pain-close-batch` | PAIN 可关项批量关单（有证据） | **LIVE** | W4+ | 只关有证据 · 不假关 |
| **W11** | `cv-adr0005-onepager` | 薄壳评估 1 页 **DEFER 实现** | **ACCEPT** `b4cbc94` · origin · wt rm | — | 无壳代码 |
| **W12** | `cv-long-verify` | `npm test` 及触及 script **全记 exit** | **LIVE** | W2–W8 | 汇总 evidence · exit 表 |
